...
(define (sudoku-solver sudoku-problem)
  ...
  (define (domain-constriant-propagation)
    ...
    (define (min-length-element)
        ...
        (map
         (lambda(x)
           (cond
             ((list? x)
              (cond
                ((and (> max-length (length x)) (< (length x) 3))
                 (set! max-length (length x))
                 (set! column-position pos-count)
      ...
      (define (element-in-row)
        ...
        (cond
          ...
          (else
           (list-ref list-elements column-position)
           )
        )            
        )
      
      (list (element-in-row) (list row-position column-position))
      )

    (define (same-in-row passed-element)
      (display "\nInside same in row") (newline)
      (display "passed element: ")
      (display passed-element) (newline)
      ...
      (display "element: ")
      (display (car passed-element)) (newline)
    ...
    (check list1)
      ...
      (display "return from check-rowlist-element: ")
      (display (check-rowlist-element row-elements (car passed-element)))
      (newline)
    ...
    (check list1)
      ...
      (display "return from check-columnlist-element: ")
      (display (check-columnlist-element column-elements (car passed-element)))
      (newline)     
    ...
    (define (same-in-box passed-element)
     ...
     (define box-starting-column-position (box-starting-index column))
      ...
      (display "Box elements positions: ")
      (display box-elements-positions) (newline)

      (display "given-element-position: ")
      (display given-element-position) (newline)
      ...
      (display "return from check-boxlist-element: ")
      (display (check-boxlist-element box-elements (car passed-element)))
      (newline)
    ...
    (define (subset-in-row passed-element)
      (display "\nInside subset in row") (newline)
      (display "\nInside same in box") (newline)
      (display "passed element: ")
      (display passed-element) (newline)
    ...
    (define (subset-in-column passed-element)
      (display "\nInside subset in column") (newline)
      '#t
      )

    (define (subset-in-box passed-element)
      (display "\nInside subset in box") (newline)
      '#t
      )
    ...
    (define (propagation-operation)
      (set! curr-element (min-length-element))
      ...
      (cond
        (curr-element
         (cond
           ...
           (else
            (cond
              ((subset-in-row curr-element)
              (set! same-element (subset-in-row curr-element))
              (element-operation curr-element same-element)
              ;do some thing
              )
              ((subset-in-column curr-element)
               (set! same-element (subset-in-column curr-element))
               (element-operation curr-element same-element)
               ;do some thing
               )
              ((subset-in-box curr-element)
               (set! same-element (subset-in-box curr-element))
               (element-operation curr-element same-element)
               ;do some thing
               )
             )            
